    ...
    "paths": {
        ...
        "/v1/minio/file/{filename}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request - Missing filename or bucket name",
                        "schema": {
                            "type": "object",
        ...
        "/v1/minio/get-file-content": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Get file content request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/v1/minio/get-file-url": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Get file URL request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
